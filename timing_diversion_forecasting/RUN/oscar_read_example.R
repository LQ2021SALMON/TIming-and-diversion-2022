...
gridmean.wide.area1_Jan <- filter(data.gridmean.wide, group == 1, month== 1, year >=1993 & year <= 2021)
#write.csv(gridmean.wide.area1_Jan, file = "gridmean.wide.A1Jan.csv")
gridmean.wide.area2_Jan <- filter(data.gridmean.wide, group == 2, month== 1, year >=1993 & year <= 2021)
#write.csv(gridmean.wide.area2_Jan, file = "gridmean.wide.A2Jan.csv")
gridmean.wide.area3_Jan <- filter(data.gridmean.wide, group == 3, month== 1, year >=1993 & year <= 2021)
...
#linear regression between timing and current velocity in January of return year using 3 areas
# for early stuart
